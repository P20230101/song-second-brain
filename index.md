...
- [设备、触发与事件核对表](实验/PA12-双轴-DIC-VFM/01_设备与同步核对表.md) — 先按真实设备记录填写双轴通道、行程、采样和共同触发信息。
...
- [科研产出型 Skills 选择与使用](wiki/科研产出型Skills-选择与使用.md) — 说明已安装技能的科研分工、为什么能形成可发表产出，以及相机型号与测量参数的阶段边界。
- [阶段 1｜研究问题决策与下一步](wiki/阶段1-研究问题决策与下一步-2026-09-12.md) — 将新增文献证据转成 B 主线、A 同步闸门、C 扩展候选及下一阶段文件。
- [PA12 双轴-DIC-VFM｜最小预试验矩阵](实验/PA12-双轴-DIC-VFM/05_最小预试验矩阵.md) — 在未知相机型号和正式载荷前，按单变量原则验证事件链、2D DIC 和整体/全场对照。
- [VFM 软件识别闭环与本构参数验收](wiki/VFM软件识别闭环与本构参数验收.md) — 固定从 MatchID 2019 场量和双轴边界力到本构参数、独立验证和不确定度报告的软件接口。
- [论文启发与 GitHub 工作时间线](wiki/论文启发与GitHub工作时间线.md) — 将用户论文、方法论文的可迁移启发与每日北京时间提交记录对应起来。
