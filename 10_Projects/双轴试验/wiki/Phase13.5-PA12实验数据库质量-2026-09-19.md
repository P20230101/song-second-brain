...
本页记录的是修复前的候选实验闭合扫描，原文中的“8 个有效实验”不再是当前数据库准入口径。2026-09-19 完成 Phase 12.1–12.3 重审和三级修复后，当前权威状态为：5 组 `quality_passed`、0 组 `constitutive_validated`；以 [一级二级三级修复与 Phase 13/14 质量门](PA12-一级二级三级修复与Phase13-14质量门-2026-09-19.md) 和 `database_quality_report.json` 为准。
...
- [真实实验成果总览](PA12-Phase6-13.5真实实验成果总览-2026-09-19.md)
