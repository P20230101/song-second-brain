...
“原始存在”不等于“VFM 可用”。当前已确认用户给出的中心厚度为 1.0 mm，S16 图像 manifest 覆盖 259 帧，`DIC-xy_0.2` 文件名覆盖原始帧 0–132（其中 0–131 质量稳定、132 无效）。但逐帧场量仍只覆盖这一子集，事件表没有有效共同触发事件，单位和边界力绑定仍需验证。因此可以立即开展名义几何和 0–131 帧候选 VFM，不能宣称已完成全程真实 VFM 识别。
