...
| `data_source_path` | `D:\松的第二大脑\松的第二大脑\raw` | 原始 PDF、数据集和外部来源；只读保存 |
| `code_and_images_path` | `D:\松的第二大脑\松的第二大脑\实验` | 可执行代码、Notebook、模型输出和图片 |
...
```text
读取 AGENTS.md、index.md、wiki/研究上下文.md 和本页。
启动研究编排流程。
研究主题：[主题]
成果路径：D:\松的第二大脑\松的第二大脑
原始数据路径：D:\松的第二大脑\松的第二大脑\raw
代码与图像路径：D:\松的第二大脑\松的第二大脑\实验
...
- 不把模型输出直接写成论文结论；先回到 `wiki/研究上下文.md`，标注证据、推断、限制和下一步。
