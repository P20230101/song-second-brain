...
- 每日学习闭环内容已并入 `wiki/01_研究总控/研究上下文.md`、当日日报和 21:00 审查任务，并登记到 `index.md`。

## [2026-09-10] query | 接入 Codex 的每日学习闭环

- 来源：用户确认创建研究上下文模板，并要求将每日对话集中记录、按论题或开题报告自动整理分析。
- 新增：`wiki/01_研究总控/研究上下文.md`，作为每日分析的唯一研究依据；`每日对话记录.md` 作为本地私有追加日志。
- 受影响页面：`AGENTS.md`、`index.md`、`wiki/01_研究总控/研究上下文.md`。
...
- 未修改：`raw/` 和 `wiki/01_研究总控/研究上下文.md`。
...
- 新增：[`wiki/04_文献与工具/文献捕获与筑巢.md`](wiki/04_文献与工具/文献捕获与筑巢.md) 与 `raw/参考文献/README.md`。
...
- 新增 [`wiki/04_文献与工具/科研流水线SOP.md`](wiki/04_文献与工具/科研流水线SOP.md) 和 `实验/README.md`，固定阶段 0–3 的路径、技能映射和人工确认门。

## [2026-09-11] setup | 固定工程力学双轴 DIC-VFM 研究路线

- 根据用户确认的工程力学方向、双轴拉伸/压缩试验、10 kN 力值、0–100 mm 行程和 DIC + VFM 方法，更新 `wiki/01_研究总控/研究上下文.md`。
- 新增 [`wiki/01_研究总控/工程力学-双轴DIC-VFM研究路线.md`](wiki/01_研究总控/工程力学-双轴DIC-VFM研究路线.md)，固定从选题、文献矩阵、设备核对、预试验、正式试验、三路数据交叉验证到小论文/大论文的阶段闸门和输出文件。
- 目录与文件分类规则已并入 [`wiki/05_结果与论文/README.md.md`](wiki/05_结果与论文/README.md.md) 与 `实验/README.md`。
...
- 种子文献初筛结论已并入 [`wiki/04_文献与工具/双轴-DIC-VFM-两篇核心文献研读-PA12路线.md`](wiki/04_文献与工具/双轴-DIC-VFM-两篇核心文献研读-PA12路线.md) 和实验方法矩阵。
...
- 新增 [`wiki/04_文献与工具/Semantic-Scholar下载配置.md`](wiki/04_文献与工具/Semantic-Scholar下载配置.md)，记录本机配置和公开 PDF 下载边界。
...
- 新增 [`wiki/02_实验与VFM/双轴-DIC-VFM-同步采集与预试验方案.md`](wiki/02_实验与VFM/双轴-DIC-VFM-同步采集与预试验方案.md)，明确相机帧率不必等于 DAQ 采样率，但每个 VFM 图像帧必须具有可核验的帧—采样映射、触发事件和同步残差。
- 更新 `wiki/01_研究总控/研究上下文.md`、`wiki/01_研究总控/工程力学-双轴DIC-VFM研究路线.md`、`raw/设备/README.md` 与 `index.md`，并将准静态/动态 VFM 分流、DIC 面外运动与正式试验前的同步验证写为固定闸门。
...
- 新增 [`wiki/04_文献与工具/双轴-DIC-VFM-两篇核心文献研读-PA12路线.md`](wiki/04_文献与工具/双轴-DIC-VFM-两篇核心文献研读-PA12路线.md)，区分晶格压缩设备案例与 PA12 十字形试样基线，固定正式 3D DIC 的复现缺口和后续 VFM 闸门；袁文件夹中的 2D 工程仅保留为历史基线。
- 更新 `wiki/01_研究总控/研究上下文.md` 与 `index.md`：PA12 双轴拉伸作为暂定材料路线；FDM-PLA 晶格压溃不纳入拟研究对象。

## [2026-09-11] setup | 建立 MinerU 图文解析与科研周期报告

- 新增 [`wiki/04_文献与工具/MinerU-PDF解析与图文研读流程.md`](wiki/04_文献与工具/MinerU-PDF解析与图文研读流程.md)，固定原始 PDF、MinerU Markdown、图片、结构化清单和 Wiki 结论的分层关系；文字型 PDF 的正式解析只采用非 OCR 路径。
...
- 更新 `wiki/01_研究总控/研究上下文.md`：MatchID 版本固定为 2019，后续优先核对该版本可导出的场量、质量指标和元数据格式。
...
- 方法比较与候选创新点已并入 [`wiki/01_研究总控/阶段1-候选方向证据决策-2026-09-12.md`](wiki/01_研究总控/阶段1-候选方向证据决策-2026-09-12.md)，统一按阶段 1 维护。
...
- 完成 `yuan` 文件夹的论文与数据只读审计，结论统一写入 [`wiki/04_文献与工具/yuan-仿真与实验数据深入分析-2026-09-12.md`](wiki/04_文献与工具/yuan-仿真与实验数据深入分析-2026-09-12.md)。
- 科研技能的安装位置与分工已并入 [`wiki/04_文献与工具/科研流水线SOP.md`](wiki/04_文献与工具/科研流水线SOP.md)，不再保留独立技能说明页。

## [2026-09-12] design | 固定阶段 1、最小预试验和 VFM 软件接口

- 阶段 1 研究问题决策已统一写入 `wiki/01_研究总控/阶段1-候选方向证据决策-2026-09-12.md`：将全场信息贡献列为主线候选 B，将同步误差列为质量闸门 A，将几何/加载路径列为扩展候选 C。
- 新增 `实验/PA12-双轴-DIC-VFM/05_最小预试验矩阵.md`：按单变量原则固定事件链、平面/刚体 DIC、MatchID 2019 参数扫描、低载荷基线和整体/全场对照。
- 新增 `wiki/02_实验与VFM/VFM软件识别闭环与本构参数验收.md`：固定从 MatchID 2019 场量和双轴边界力到本构参数、独立验证和不确定度报告的软件接口。
- 新增 `wiki/04_文献与工具/论文启发与GitHub工作时间线.md`：按论文启发和北京时间 Git 提交记录对应每日研究产出。

## [2026-09-12] maintenance | 按日期重排 Wiki 导航

- 根目录 `index.md` 改为按 2026-09-10、2026-09-11、2026-09-12 和报告日期分区，固定系统入口单独列出。
- `wiki/05_结果与论文/README.md.md` 同步记录日期分区和“首建日期/后续更新以 Git 与维护日志为准”的规则。
...
- 新增 [`wiki/04_文献与工具/yuan-仿真与实验数据深入分析-2026-09-12.md`](wiki/04_文献与工具/yuan-仿真与实验数据深入分析-2026-09-12.md)，把 3D DIC—同步四通道边界力—VFM/FEMU—有限元预测串成小论文与大论文的连续路线，并给出下一次只需提供一份匹配试验包的执行入口。
...
- 新增 [`wiki/01_研究总控/阶段1-候选方向证据决策-2026-09-12.md`](wiki/01_研究总控/阶段1-候选方向证据决策-2026-09-12.md)：把 `yuan` 的 MatchID 2019 2D 复现锁定为立即执行基线，3D 仅在取得双视角、空间标定和三向导出后作为校核分支。
...
- `index.md` 与 `wiki/05_结果与论文/README.md.md` 已改为核心页面导航；历史提交说明保留在本日志中，不再作为当前入口。
...
- 自动任务会检查 Wiki 重复页、空草稿、失效链接和过程性文件；只有确认无独立证据/行动且已有替代页面时才删除，并同步更新 `index.md`、`wiki/05_结果与论文/README.md.md` 和 `log.md`。
- 明确保护用户 README 改动、`tmp/`、`raw/`、PDF、MinerU 私有产物、实验原始数据、脚本、实验接口和不确定归属的文件；无实质变化时不提交、不推送。

## [2026-09-12] maintenance | 重新整理日常入口与报告口径

- 核对根目录 `index.md`、`wiki/05_结果与论文/README.md.md` 与 `实验/PA12-双轴-DIC-VFM/results/`：日常入口仍仅为 `01_VFM照片力对应.csv` 和 `02_事件和频率概览.md`，详细审计底稿均位于 `results/审计/`。
...
- 更新 `index.md`、`wiki/01_研究总控/研究上下文.md`、`wiki/04_文献与工具/yuan-仿真与实验数据深入分析-2026-09-12.md`、VFM 闭环、同步预试验、核心文献路线及 2026-09-12 日报：将当前平面标定、面内场量、刚体检验、面外运动风险和 2D VFM 输入写为执行要求。
...
- 新增 [`wiki/04_文献与工具/文献矩阵标准化表-2026-09-13.md`](wiki/04_文献与工具/文献矩阵标准化表-2026-09-13.md) 和 [`wiki/01_研究总控/阶段1-文献矩阵交叉对比与创新候选-2026-09-13.md`](wiki/01_研究总控/阶段1-文献矩阵交叉对比与创新候选-2026-09-13.md)，交叉结论为 I1→I2→I3→I4；I5/I6 仅作后续扩展。
...
- 新增 [`wiki/04_文献与工具/全文证据与实现参数-PA12双轴-DIC-VFM-2026-09-13.md`](wiki/04_文献与工具/全文证据与实现参数-PA12双轴-DIC-VFM-2026-09-13.md)：记录章节级证据、公式/数值、可迁移边界、交叉验证矩阵、数据契约、事件窗口、VFM 阶梯和准入闸门。
...
- 新增 [`wiki/01_研究总控/总体研究背景与方法框架-PA12双轴-DIC-VFM.md`](wiki/01_研究总控/总体研究背景与方法框架-PA12双轴-DIC-VFM.md)，固定工程问题、科学问题、双轴加载、共同触发、DIC、同步、代码 VFM、有限元验证与小论文/大论文分层之间的关系。
- 明确将当前 `DIC-xy_0.2` 的 133 帧 `X/Y/U/V/R/Sigma` 导出定位为二维 DIC 基线：可做场量与质量控制，但在未绑定力、厚度、标定和边界前不写作 VFM 参数识别结果。
- 根目录 `index.md` 与 `wiki/05_结果与论文/README.md.md` 增加总背景页入口；未修改或移动原始 DIC、图像、PDF、Excel、MatchID 工程和既有实验结果。
...
- 复核当天的 L0 VFM 合成闭环、噪声敏感性和 Abaqus 平面应力派生场量；将其作为可复现数值基准登记到 `index.md` 与 `wiki/05_结果与论文/README.md.md`，不表述为真实 PA12 参数识别。
- 保留 `wiki/03_仿真与验证/应力应变曲线近似结果-2026-09-15.md`，但核实其所列 `VFM同步结果_中文精简版_20260915/应力应变近似版/` 不在双轴研究根目录；已在页面和日报标明 CSV/PNG 尚待归档。
...
- 新增 [`wiki/03_仿真与验证/双轴试样夹具仿真优化-46篇文献与Abaqus结果-2026-09-17.md`](wiki/03_仿真与验证/双轴试样夹具仿真优化-46篇文献与Abaqus结果-2026-09-17.md) 与当日日报。公开仓库只纳入决策页和汇总图；ODB、原始场、用户数据及本地模型继续保存在 D 盘。
...
- 新增 [`wiki/02_实验与VFM/真实PA12中心试样-证据与建模契约-2026-09-17.md`](wiki/02_实验与VFM/真实PA12中心试样-证据与建模契约-2026-09-17.md)，固定“实际几何—DIC 场—四通道力—VFM—Abaqus 独立验证”主线，明确 Yuan 论文的 1 mm/7 条狭缝/40 mm/3 mm/0.2 mm 仅作文献基准，不能替代 as-built 尺寸。
...
- 新增 [`wiki/03_仿真与验证/PA12-Abaqus-VFM-StageA基准闭环-2026-09-17.md`](wiki/03_仿真与验证/PA12-Abaqus-VFM-StageA基准闭环-2026-09-17.md) 和项目内 `results/abaqus_vfm_gate_audit.md`；未移动、删除或公开 ODB、PDF、图片、MatchID 工程、机器数据和原始实验数据。
...
- 重生成主试样 259 帧和全集 6,327 帧本地审计表；行数与可解析数不变。新增 [`wiki/02_实验与VFM/PA12-MatchID-DAT字段Schema审计-2026-09-17.md`](wiki/02_实验与VFM/PA12-MatchID-DAT字段Schema审计-2026-09-17.md) 与项目内 schema 审计页。
...
- 新增 Wiki 页 `wiki/03_仿真与验证/PA12-M0-M2合成FE-VFM基线-2026-09-17.md`。当前仅 synthetic Gate 3/4 通过，Gate 5 只有 M0 的 20-start LHS 部分通过；M1/M2 多初值、噪声、FIM 和路径信息增益仍待完成。
...
- 新增 `wiki/02_实验与VFM/Phase6-真实MatchID数据接入-2026-09-18.md`，更新 `双轴/index.md`、字段映射页和总项目进度；原始图像、`.dat`、工程和力文件保持只读。
...
- 生成并审核 17 张正式真实图像，图像问题和力学内容问题均为 0；更新 [PA12｜一级二级三级修复与 Phase 13/14 质量门](wiki/01_研究总控/PA12-一级二级三级修复与Phase13-14质量门-2026-09-19.md) 和首页索引。
...
- 记录页：[Phase 12.1｜真实数据审查与本构模型阶梯](wiki/03_仿真与验证/Phase12.1-真实数据本构审查与模型阶梯-2026-09-19.md)。
...
- 解释页：[PA12｜J2 与 VFM 讲解图集](wiki/05_结果与论文/PA12-J2与VFM讲解图集-2026-09-19.md)。
...
- 详细记录：[PA12｜真实单轴问题总审计](wiki/02_实验与VFM/PA12-真实单轴问题总审计-2026-09-19.md)。
